.onAttach <- function(libname, pkgname) {
  ...
  if (!any(grepl("Roboto|Roboto[ ]Condensed", fnt$FamilyName))) {
    packageStartupMessage("NOTE: Roboto and Roboto Condensed fonts are required for the default setting of theme_mt() to work.")
    packageStartupMessage("      Please use mt::import_fonts() to install Roboto and Roboto Condensed")
  } # nocov end
